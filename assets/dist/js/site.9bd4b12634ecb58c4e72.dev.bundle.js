...
module.exports = __webpack_require__(2838);
...
$(function () {
    $('#cbw-nav-search').submit(function () {
        var keyword = $('#cbw-nav-search-keywords').val().trim();
        if (keyword) {
...
/* Navigation Search */
$(function () {
    $('#cbw-mobile-search').submit(function () {
        var keyword = $('#cbw-mobile-search-keywords').val().trim();
        if (keyword) {
            window.location = '/search/#/' + keyword;
        }
        return false;
...
//# sourceMappingURL=site.9bd4b12634ecb58c4e72.dev.bundle.js.map